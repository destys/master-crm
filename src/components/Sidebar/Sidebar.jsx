...
const Sidebar = () => {
  ...
  return (
    <>
      <div className="w-64 absolute hidden sm:relative bg-gray-800 shadow flex-col justify-between sm:flex basis-2/12">
          ...
          <ul className="mt-12">
            ...
            <li className="flex w-full justify-between text-gray-50 hover:text-gray-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <span className="text-sm  ml-2">Невыданные</span>
              </div>
              <div className="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs">
                8
              </div>
          ...
          <ul className="mt-12">
            <li className="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <Link to="/dashboard" className="text-sm  ml-2">
                  Клиенты
                </Link>
              </div>
              <div className="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs">
            ...
            <li className="flex w-full justify-between text-gray-50 hover:text-gray-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <span className="text-sm  ml-2">Телефония</span>
              </div>
            </li>
          </ul>
      ...
      >
        ...
        <div className="px-8">
          ...
          <ul className="mt-12">
            ...
            <li className="flex w-full justify-between text-gray-50 hover:text-gray-500 cursor-pointer items-center">
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
